 ...
 * @author Joren Six
 */
public final class TarsosDspMpm {
	 ...
	 */
	public TarsosDspMpm(final float audioSampleRate) {
	 ...
	 */
	public TarsosDspMpm(final float audioSampleRate, final int audioBufferSize) {
	 ...
	 *            paper 0.93 is used.
	 */
	public TarsosDspMpm(final float audioSampleRate, final int audioBufferSize, final double cutoffMPM) {
